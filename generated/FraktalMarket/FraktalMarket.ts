...
export class FraktalMarket extends ethereum.SmartContract {
  ...
  auctionListings(
    ...
    let result = super.call(
      "auctionListings",
      "auctionListings(address,address,uint256):(address,uint256,uint256,uint256,string)",
      [
  ...
  offers(param0: Address, param1: Address): FraktalMarket__offersResult {
    let result = super.call(
      "offers",
    ...
    return new FraktalMarket__offersResult(
      result[0].toBigInt(),
      result[1].toBoolean()
    );
  }
  ...
  try_offers(
    param0: Address,
    param1: Address
  ): ethereum.CallResult<FraktalMarket__offersResult> {
    let result = super.tryCall(
      "offers",
      "offers(address,address):(uint256,bool)",
      [ethereum.Value.fromAddress(param0), ethereum.Value.fromAddress(param1)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraktalMarket__offersResult(value[0].toBigInt(), value[1].toBoolean())
    );
  }
