...
export class FraktalFactory__lockedERC1155sResult {
  value0: Address;
  value1: BigInt;
...
export class FraktalFactory__lockedERC721sResult {
  value0: Address;
  value1: BigInt;
...
export class FraktalFactory extends ethereum.SmartContract {
  static bind(address: Address): FraktalFactory {
    return new FraktalFactory("FraktalFactory", address);
  }
  ...
  lockedERC1155s(param0: Address): FraktalFactory__lockedERC1155sResult {
    let result = super.call(
      "lockedERC1155s",
    ...
    return new FraktalFactory__lockedERC1155sResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_lockedERC1155s(
    param0: Address
  ): ethereum.CallResult<FraktalFactory__lockedERC1155sResult> {
    let result = super.tryCall(
      "lockedERC1155s",
      "lockedERC1155s(address):(address,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new FraktalFactory__lockedERC1155sResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  lockedERC721s(param0: Address): FraktalFactory__lockedERC721sResult {
    let result = super.call(
      "lockedERC721s",
    ...
    return new FraktalFactory__lockedERC721sResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_lockedERC721s(
    param0: Address
  ): ethereum.CallResult<FraktalFactory__lockedERC721sResult> {
    let result = super.tryCall(
      "lockedERC721s",
      "lockedERC721s(address):(address,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraktalFactory__lockedERC721sResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
